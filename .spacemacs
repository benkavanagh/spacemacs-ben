...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(rainbow-mode muse key-chord)
...
you should place your code here."
  ...
  ;; (if I package-ized these properly and added to 'additional-packages')
  (add-to-list 'load-path "~/.emacs.d/private/local/spacemacs-ben/")
  (add-to-list 'load-path "~/.emacs.d/private/local/record-type/")
  ...
  (setq custom-file "~/.emacs.d/private/local/spacemacs-ben/spacemacs-ben-custom.el")
  (load custom-file))
